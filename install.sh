...
# Install packages
apt-get install -y xorg openbox alsa aufs-tools tint2 chromium-browser flashplugin-nonfree tor tor-geoipdb xfce4-terminal vim git vlc nmap zenmap xchat miredo vidalia gksu bzip2 bcrypt
...
wget --no-check-certificate -O /etc/xdg/openbox/menu.xml https://raw.github.com/charlvanniekerk/hypervenster/master/menu.xml

# Configure tint2
echo 'tint2 &' >> /etc/xdg/openbox/autostart.sh
mkdir -p /home/user/.config/tint2
wget --no-check-certificate -O /home/user/.config/tint2/tint2rc https://raw.github.com/charlvanniekerk/hypervenster/master/tint2rc
...
wget --no-check-certificate -O /etc/initramfs-tools/scripts/init-bottom/rootaufs https://raw.github.com/charlvanniekerk/hypervenster/master/rootaufs.sh
